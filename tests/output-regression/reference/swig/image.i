...
#
print 't----t twopointcorrelation Ex 1 t----'
...
Input Parameters:
    ...
    format                    Format of data in ascii file
    maskvalue                 Value to replace masked pixels by, -999 is no change.
    overwrite                 Overwrite (unprompted) pre-existing output file?
    stretch                   Stretch the mask if necessary and possible? Default False
...
Input Parameters:
    ...
    dovelocity                Compute corresponding spectral velocities?
