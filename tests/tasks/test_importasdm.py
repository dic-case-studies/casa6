...
class test_base(unittest.TestCase):
    def setUp_m51(self):
        ...
        datapath=ctsys.resolve(os.path.join('regression/asdm-import/input',myasdm_dataset_name))
        shutil.copytree(datapath, myasdm_dataset_name)
        datapath=ctsys.resolve(os.path.join('regression/exportasdm/input',myms_dataset_name))
    ...
    def setUp_autocorr(self):
        ...
        datapath=ctsys.resolve(os.path.join('regression/unittest/importasdm',self.asdm))
        if(not os.path.lexists(self.asdm)):
            os.system('ln -s '+datapath+' '+self.asdm)
