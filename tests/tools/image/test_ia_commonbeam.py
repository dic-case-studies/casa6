...
class ia_commonbeam_test(unittest.TestCase):
    ...
    def test_nobeam(self):
        ...
        self.ia.fromshape("", [2,2,2])
        self.assertRaises(Exception, self.ia.commonbeam)
        self.ia.done()
    ...
    def test_enclosingbeam(self):
        ...
        self.ia.setrestoringbeam(major=major, minor=minor, pa=pa, polarization=0)
        self.ia.setrestoringbeam(major="1arcsec", minor="1arcsec", pa="0deg", polarization=1)
        x = self.ia.commonbeam()
        print(str(x))
    ...
    def test_onebeam(self):
        ...
        minor = {'value': 2.0, 'unit': 'arcsec'}
        pa = {'value': 0.0, 'unit': 'deg'}
        self.ia.setrestoringbeam(major=major, minor=minor, pa=pa)
        x = self.ia.commonbeam()
        self.assertTrue(x['major'] == major)
        self.assertTrue(x['minor'] == minor)
        self.assertTrue(x['pa'] == pa)
    ...
    def test_overlappingbeams(self):
        ...
        major = {'value': 4.0, 'unit': 'arcsec'}
        minor = {'value': 2.0, 'unit': 'arcsec'}
        self.ia.setrestoringbeam(major=major, minor=minor, pa="0deg", polarization=0)
        self.ia.setrestoringbeam(major=major, minor=minor, pa="60deg", polarization=1)
        x = self.ia.commonbeam()
        print(str(x))
