...
#-------------------------------------------------#
    ...
    def test_standard_cal(self):
        ...
        exp_im_stats = {'com_bmaj': [False, 9.62653827667],
            'com_bmin': [False, 4.67397546768],
            ...
            'im_rms': [False, 0.201287220155],
            'im_sum': [False, 168.25755220],
            'regn_sum': [False, 167.478445882],
            'npts_real': [True, 8100],
            'fit': [False, [2.40974849537, 9.60566422443, 4.61946099469]],
            'fit_loc_chan': [True, 0],
