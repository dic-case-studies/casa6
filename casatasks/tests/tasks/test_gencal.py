...
class TestJyPerK(unittest.TestCase):
    ...
    jyperk_factor_csv = os.path.join(datapath, 'jyperk/jyperk_factor.csv')

    # The caltable is generated by each gencal task.
    caltable = 'generated_caltable_by_gencal.cal'
    ...
    def test_jyperk_gencal_for_asdm_web_api(self, mock_retrieve):
        ...
        * endpoint='asdm'
        ...
        responses = self._load_jyperkdb_responses(os.path.join(datapath, 'jyperk/jyperkdb_responses_for_asdm.csv'))
        ...
        reference_caltable = os.path.join(datapath, 'jyperk/caltable_for_jyperk_with_asdm_web_api.cal')
    ...
    def test_jyperk_gencal_for_model_fit_web_api(self, mock_retrieve):
        ...
        * endpoint='model-fit'
        ...
        responses = self._load_jyperkdb_responses(os.path.join(datapath, 'jyperk/jyperkdb_responses_for_model-fit.csv'))
        mock_retrieve.side_effect = get_response
        ...
        reference_caltable = os.path.join(datapath, 'jyperk/caltable_for_jyperk_with_model_fit_web_api.cal')
        self.assertTrue(th.compTables(self.caltable, reference_caltable, ['WEIGHT']))
    ...
    def test_jyperk_gencal_for_interpolation_web_api(self, mock_retrieve):
        ...
        * endpoint='interpolation'
        ...
        responses = self._load_jyperkdb_responses(os.path.join(datapath, 'jyperk/jyperkdb_responses_for_interpolation.csv'))
        mock_retrieve.side_effect = get_response
        ...
        reference_caltable = os.path.join(datapath, 'jyperk/caltable_for_jyperk_with_interpolation_web_api.cal')
        self.assertTrue(th.compTables(self.caltable, reference_caltable, ['WEIGHT']))
    ...
    def test_jyperk_gencal_for_factor_file(self):
        ...
        * infile
        ...
        reference_caltable = os.path.join(datapath, 'jyperk/caltable_for_jyperk_with_factor_file.cal')
        self.assertTrue(th.compTables(self.caltable, reference_caltable, ['WEIGHT']))
