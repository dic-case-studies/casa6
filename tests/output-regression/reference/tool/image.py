...
class image:
    ...
    def fromcomplist(self, outfile='', shape=[  ], cl=[ ], csys={ }, overwrite=False, log=True, cache=True):
        ...
        """
        schema = {'outfile': {'type': 'cStr'}, 'shape': {'type': 'cIntVec', 'coerce': [_coerce.to_list,_coerce.to_intvec]}, 'cl': {'type': 'cVariant'}, 'csys': {'type': 'cDict'}, 'overwrite': {'type': 'cBool'}, 'log': {'type': 'cBool'}, 'cache': {'type': 'cBool'}}
