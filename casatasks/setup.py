...
def generate_pyinit(moduledir,tasks):
    ...
    with open(outfile, "w") as fd:
        ...
        fd.write('          telemetrylogger.logger.info("Stopping CASA at: " + str(_time.now()) + \n') 
        fd.write('          " Version " + version_string() + " Platform: " + platform.platform() +  " Start time: " + telemetry_starttime + " Variant: " + variant)\n')
