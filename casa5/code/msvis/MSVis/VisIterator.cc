...
public:
  ...
  // original ms row
  Vector<casacore::rownr_t>& rowIds(Vector<casacore::rownr_t>& rowids) const;
...
ROVisIteratorImpl::setTileCache()
{
  ...
  Vector<casacore::rownr_t> rownums;
  rowIds(rownums);
...
void ROVisIteratorImpl::setSelTable()
{
    ...
    Vector<casacore::rownr_t> rows(curNumRow_p);
...
Vector<casacore::rownr_t>& ROVisIteratorImpl::rowIds(Vector<casacore::rownr_t>& rowids) const
{
