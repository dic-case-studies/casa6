...
RegionTextParser::RegionTextParser(
    ...
    Bool verbose, bool requireLCRegion
    ...
    contents += chunk;
    _parse(contents, filename, requireLCRegion);
}
...
void RegionTextParser::_parse(const String& contents, const String& fileDesc, bool requireLCRegion) {
...
void RegionTextParser::_createAnnotation(
    ...
    const String& preamble, Bool requireLCRegion
) {
    ...
    switch (annType) {
        ...
        case AnnotationBase::ROTATED_BOX:
            annotation = new AnnRotBox(
                ...
                freqRefFrame, doppler, restfreq,  stokes, annOnly, requireLCRegion
            );
            break;
        case AnnotationBase::POLYGON:
            {
