...
And for mtmfs
exp_im1_stats, exp_model1_stats, exp_resid1_stats, exp_subwt1_stats
...
#        self.delData()
    ...
    def save_dict_to_file(self, topkey, indict, outfilename, outformat='pickle'):
        """ function that will save input Python dictionaries to file (json) 
            Create a separate file with outfilename_tokey for now
        """
        if type(indict)!=dict:
...
class Test_standard(test_tclean_base):
    ...
    def test_standard_cube(self):
        ...
        savedict = {}
        #list of exp stats to save
        # exp_im_stats, exp_mask_stats, exp_pb_stats, exp_psf_stats,\
        # exp_model_stats, exp_resid_stats, exp_sumwt_stats]
        savedict['im_stats_dict']=im_stats_dict
        savedict['mask_stats_dict']=mask_stats_dict
        ...
        self.save_dict_to_file('standard_cube',savedict, 'cas13317stats')
...
#-------------------------------------------------#
    ...
    def test_standard_cube_briggsbwtaper(self):
        ...
        test_dict['test_standard_cube_briggsbwtaper']['self.parallel'] = self.parallel
        ...
        self.save_dict_to_file('standard_cube_briggsbwtaper',savedict, 'cas13317stats')
...
# End of est_standard_cube_eph_briggsbwtaper
#-------------------------------------------------#
    @stats_dict(test_dict)
    # @unittest.skip("")
...
#-------------------------------------------------#
    ...
    def test_mosaic_cube_briggsbwtaper(self):
        ...
        test_dict['test_mosaic_cube_briggsbwtaper']['self.parallel'] = self.parallel
...
#-------------------------------------------------#
    ...
    def test_mosaic_cube_eph_briggsbwtaper(self):
        ...
        self.mom8_creator(img+'.image', range_list=[-0.01, 0.1])
        self.mom8_creator(img+'.residual', range_list=[-0.01, 0.1])
        test_dict['test_mosaic_cube_eph_briggsstaper']['images'].extend( \
            (img+'.image.moment8.png',img+'.residual.moment8.png'))
