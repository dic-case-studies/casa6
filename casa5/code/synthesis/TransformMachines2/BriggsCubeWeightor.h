...
class BriggsCubeWeightor{
  public:
   ...
   BriggsCubeWeightor(const casacore::String& rmode,
	...
	void initImgWeightCol(vi::VisibilityIterator2& vi,const casacore::ImageInterface<casacore::Complex>& templateimage, const casacore::RecordInterface& inRec);
  ...
  private:
	...
	void makeScratchImagingWeightTable(casacore::CountedPtr<casacore::Table>& weightTable);
	...
	std::map<std::pair<casacore::uInt, casacore::uInt>, casacore::uInt> vbrowms2wgtrow_p;
 };
   }//# end namespace refim
} // end namespace casa
