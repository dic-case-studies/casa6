...
Input Parameters:
    ...
    shape                     The new shape type. A string that is either 'point', 'Gaussian', 'disk', or 'limbdarkeneddisk'
    ...
    optionalparms             optional parameters in vector (currently only used for limbdarkeneddisk)
...
Input Parameters:
    which                     A vector of indices specifying the components to modify. A vector with indices between 0 and one less than the list length, inclusively
    type                      The new shape type. A string that is either 'point', 'Gaussian', 'disk', or 'limbdarkeneddisk'
    ...
    optionalparms             optional parameters in a vector (for limbdarkeneddisk) 
    log                       Send a message to the logger
