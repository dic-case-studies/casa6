...
def sdatmcor(
    ...
    # change  datacolumn name = 'CORRECTED_DATA'  to access MS. #
    # set 'DATA' after  mstransform. when CORRECTED_DATA is originally specified.
    # note that 'DATA','FLOAT_DATA' go through this block.
    # this is partly internal AtmCorr.py dependent.
