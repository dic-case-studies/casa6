...
class table:
    ...
    def fromascii(self, tablename, asciifile, headerfile='', autoheader=False, autoshape=[ int(-1) ], sep='', commentmarker='', firstline=int(0), lastline=int(-1), nomodify=True, columnnames=[ '' ], datatypes=[ '' ]):
        ...
        file.
        """
        schema = {'tablename': {'type': 'cStr'}, 'asciifile': {'type': 'cStr'}, 'headerfile': {'type': 'cStr'}, 'autoheader': {'type': 'cBool'}, 'autoshape': {'type': 'cIntVec', 'coerce': _coerce.to_intvec}, 'sep': {'type': 'cStr'}, 'commentmarker': {'type': 'cStr'}, 'firstline': {'type': 'cInt'}, 'lastline': {'type': 'cInt'}, 'nomodify': {'type': 'cBool'}, 'columnnames': {'type': 'cStrVec'}, 'datatypes': {'type': 'cStrVec'}}
    ...
    def open(self, tablename='', lockoptions={ }, nomodify=True):
        ...
        hardly ever needed.
        """
        schema = {'tablename': {'type': 'cStr'}, 'lockoptions': {'type': 'cDict'}, 'nomodify': {'type': 'cBool'}}
    ...
    def createmultitable(self, outputTableName, tables, subdirname):
        """
        """
        schema = {'outputTableName': {'type': 'cStr'}, 'tables': {'type': 'cStrVec'}, 'subdirname': {'type': 'cStr'}}
    ...
    def toasciifmt(self, asciifile, headerfile='', columns=[ '' ], sep=''):
        ...
        """
        schema = {'asciifile': {'type': 'cStr'}, 'headerfile': {'type': 'cStr'}, 'columns': {'type': 'cStrVec'}, 'sep': {'type': 'cStr'}}
    ...
    def removecols(self, columnames):
        ...
        """
        schema = {'columnames': {'type': 'cStrVec'}}
