...
#    forcereload=False
    ...
    def setUp_vis_g(self):
        if testmms:
            ...
            myms.addephemeris(0,ctsys.resolve('ephemerides/JPL-Horizons/Jupiter_54708-55437dUTC.tab'),
    ...
    def setUp_mms_vis_c(self):
        ...
        if (not os.path.exists(vis_c)):
            os.system('cp -R '+ctsys.resolve('regression/cvel/input/jupiter6cm.demo-thinned.ms')+' .') 
