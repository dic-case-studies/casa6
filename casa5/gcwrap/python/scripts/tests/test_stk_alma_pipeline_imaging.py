...
#                + inspect.stack()[1][3] +"]"
    ...
    def image_stats(self, img, fit_region=None, field_regions=None, masks=None):
                ...
                if 'pb' in img:
                    ...
                    for region in fit_region:
                        try:
                            ...
                            stats_dict['fit_loc_'+str(i)] = [1.0, 1.0]
                    ...
                    fit_region = fit_region + ', range=[%schan,%schan]' \
                        ...
                        stats_dict['max_val_pos'][3])
            if 'psf' in img and 'cube' in img:
                stats_dict['regn_sum'] = self._myia.statistics( \
                    region=fit_region[1])['sum'][0]
            else:
                stats_dict['regn_sum'] = self._myia.statistics( \
                    region=fit_region)['sum'][0]
            if ('image' in img and 'mosaic_cube_eph' not in img) or 'pb' in img or ('psf' in img and 'cube' not in img):
                try:
                    fit_dict = self._myia.fitcomponents( \
        ...
        if 'pb' not in img and 'sumwt' not in img and not img.endswith('.mask'):
        ...
        if 'pb' in img:
            ...
            if 'cube' in img:
                pb_chans = [1, int(im_size[3]/2), int(im_size[3]-1)]
                for chan in pb_chans:
                    stats_dict['npts_0.2_'+str(pb_chans.index(chan))] = \
                        numpy.count_nonzero(pb_mask_02[chan])
                    stats_dict['npts_0.5_'+str(pb_chans.index(chan))] = \
                        numpy.count_nonzero(pb_mask_05[chan])
            else:
        ...
        if 'model' in img or img.endswith('.alpha'):
    ...
    def test_standard_cube(self):
        ...
        exp_im_stats = {'com_bmaj': [False, 8.509892605313942],
            ...
            'fit': [False, [0.9222914423989481, 14.289411729097703, \
                    6.881365508161659]],
            'fit_loc': [True, [254, 220.31469461816917]],
        ...
        exp_pb_stats = {'npts': [True, 3251200],
            ...
            'npts_0.2_1': [True, 2997],
            'npts_0.5_1': [True, 1449],
            'npts_0.2_2': [True, 2997],
            'npts_0.5_2': [True, 1449],
            'npts_real': [True, 3251200],
...
#        test_dict['test_standard_cube']['Test Description'] = \
#            test_standard_cube.__doc__
...
#        test_dict['test_standard_mfs']['Test Description'] = \
#            test_standard_mfs.__doc__
...
#        test_dict['test_standard_mtmfs']['Test Description'] = \
#            test_standard_mtmfs.__doc__
...
#-------------------------------------------------#
    ...
    def test_standard_cube_eph(self):
        ...
        exp_im_stats = {'com_bmaj': [False, 4.49769604687],
            ...
            'regn_sum': [False, 254.64532056450844],
            'npts_real': [True, 6400000],
            'profile': [False, 2.73209990935],
            'fit': [False, [3.04538752387499, 5.974552107890284, \
                    5.6824086756315]],
            'fit_loc': [True, [489, 354.5049652049504]],
            'fit_pix': [False, [45.762234863952109, 41.08882263728372]]}
        ...
        exp_pb_stats = {'npts': [True, 6400000],
            ...
            'npts_0.2_1': [True, 3233],
            'npts_0.5_1': [True, 1549],
            'npts_0.2_2': [True, 3233],
            'npts_0.5_2': [True, 1549],
            'npts_real': [True, 6400000],
            'fit': [False, [1.046847676114786, 28.075049566294457, \
                    28.075184571520158]],
            'fit_loc': [True, [500, 354.5063079930342]],
...
#        test_dict['test_standard_cube_eph']['Test Description'] = \
#            test_standard_cube_eph.__doc__
    ...
    def test_standard_mfs_eph(self):
        ...
        exp_pb_stats = {'npts': [True, 82944],
            ...
            'fit': [False, [1.0286609217550002, 22.907692916947163, \
                       22.90769291676479]],
            'fit_loc': [True, [0, 253.57442221593894]],
...
#        test_dict['test_standard_mfs_eph']['Test Description'] = \
#            test_standard_mfs_eph.__doc__
...
#        test_dict['test_standard_mtmfs_eph']['Test Description'] = \
#            test_standard_mtmfs_eph.__doc__
...
#-------------------------------------------------#
    ...
    def test_standard_cal(self):
        ...
        exp_im_stats = {'com_bmaj': [False, 9.98569583893],
            ...
            'fit_loc': [True, [0, 220.30076542192973]],
...
#        test_dict['test_standard_cal']['Test Description'] = \
#            test_standard_cal.__doc__
...
class Test_mosaic(test_tclean_base):
    ...
    def test_mosaic_cube(self):
        ...
        exp_im_stats = {'com_bmaj': [False, 8.79758467135],
            ...
            'regn_sum': [False, 71.25372600927949],
            ...
            'fit': [False, [1.1933975136224662, 8.742700027759433, \
                    8.045775824263838]],
            'fit_loc': [True, [252, 220.3142062699946]],
            'fit_pix': [False, [44.500004160810541, 38.262450667037129]]}
        ...
        exp_pb_stats = {'npts': [True, 5925312],
            ...
            'npts_0.2_1': [True, 6571],
            'npts_0.5_1': [True, 3593],
            'npts_0.2_2': [True, 6571],
            'npts_0.5_2': [True, 3594],
            'npts_real': [True, 5925312],
...
#        test_dict['test_mosaic_cube']['Test Description'] = \
#            test_mosaic_cube.__doc__
    ...
    def test_mosaic_mfs(self):
        ...
        exp_im_stats = {'com_bmaj': [False, 17.6737785339],
            ...
            'fit': [False, [0.03522500582263719, 17.46093579518058, 
                       9.709830310449933]],
            'fit_loc': [True, [0, 107.8402451422565]],
...
#        test_dict['test_mosaic_mfs']['Test Description'] = \
#            test_mosaic_mfs.__doc__
...
#        test_dict['test_mosaic_mtmfs']['Test Description'] = \
#            test_mosaic_mtmfs.__doc__
...
#-------------------------------------------------#
    ...
    def test_mosaic_cube_eph(self):
        ...
        exp_im_stats = {'com_bmaj': [False, 0.9347811147697555],
            ...
            'npts': [True, 191116800],
            'npts_unmasked': [True, 104998085.0],
        ...
        exp_pb_stats = {'npts': [True, 191116800],
            ...
            'npts_0.2_1': [True, 110747],
            'npts_0.5_1': [True, 63976],
            'npts_0.2_2': [True, 110732],
            'npts_0.5_2': [True, 63948],
            'npts_real': [True, 191116800],
            'fit': [False, [1.1057529783407027, 36.994958712675974, \
                    36.71800149173757]],
            'fit_loc': [True, [474, 261.8801035135706]],
...
#        test_dict['test_mosaic_cube_eph']['Test Description'] = \
#            test_mosaic_cube_eph.__doc__
    ...
    def test_mosaic_mfs_eph(self):
        ...
        exp_pb_stats = {'npts': [True, 201600],
            ...
            'fit': [False, [1.0977556311256869, 37.34956230416832, \
                    36.99775156676905]],
            'fit_loc': [True, [0, 253.57442262646273]],
...
#        test_dict['test_mosaic_mfs_eph']['Test Description'] = \
#            test_mosaic_mfs_eph.__doc__
...
#        test_dict['test_mosaic_mtmfs_eph']['Test Description'] = \
#            test_mosaic_mtmfs_eph.__doc__
