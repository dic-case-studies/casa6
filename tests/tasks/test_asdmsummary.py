...
class asdmsummary_test(unittest.TestCase):
    ...
    def test_alma_asdm(self):
        ...
        self.doASDMSummary('regression/asdm-import/input/uid___X5f_X18951_X1',173)
        
    def test_vla_asdm(self):
        '''VLA data'''
        # used in test_importevla, test_importasdm_mms, test_importasdm
        self.doASDMSummary('regression/unittest/importevla/X_osro_013.55979.93803716435',253)

    def test_aca_asdm(self):
        '''ACA with mixed pol/channelisation'''
        # used in test_importasdm_mms, test_importasdm
        self.doASDMSummary('regression/asdm-import/input/uid___A002_X72bc38_X000',2520)

    def test_12m_asdm(self):
        ''' 12m with mixedl pol/channelisation'''
        # used in test_importasdm_mms, test_importasdm
        self.doASDMSummary('regression/asdm-import/input/uid___A002_X71e4ae_X317_short',1024)
