...
public:
  ...
  // original ms row
  casacore::RowNumbers& rowIds(casacore::RowNumbers& rowids) const;
...
casacore::RowNumbers& ROVisIteratorImpl::rowIds(casacore::RowNumbers& rowids) const
{
