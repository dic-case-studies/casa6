...
%apply int &OUTARGINT {int &_pixels}
%apply record* &OUTARGREC {record* &_cell}
%apply int &OUTARGINT {int &_facets}
%apply string &OUTARGSTR {string &_phasecenter}
%feature("docstring", "
...
%apply record* &OUTARGREC {record* &_bmaj}
%apply record* &OUTARGREC {record* &_bmin}
%apply record* &OUTARGREC {record* &_bpa}
%feature("docstring", "
...
%apply record* &OUTARGREC {record* &_pointsource}
%apply double &OUTARGDBL {double &_relative}
%apply double &OUTARGDBL {double &_sumweights}
%apply record* &OUTARGREC {record* &_senrec}
%feature("docstring", "
...
%apply double &OUTARGDBL {double &_pointsource}
%apply double &OUTARGDBL {double &_relative}
%feature("docstring", "
