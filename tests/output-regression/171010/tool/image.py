...
from CASAtools.__casac__ import image as _image
from CASAtools.typecheck import validator as _pc
from CASAtools.coercetype import coerce as _coerce
from CASAtools.coordsys import coordsys as _wrap_coordsys
...
class image:
    ...
    def deviation(self, outfile='', region=[ ], mask='', overwrite=False, stretch=False, grid=[ int(1),int(1) ], anchor=[ ], xlength=[ ], ylength=[ ], interp='cubic', stattype='sigma', statalg='classic', zscore=float(-1), maxiter=int(-1)):
    ...
    def addnoise(self, type='normal', pars=[ float(0.0),float(1.0) ], region=[ ], zero=False, seeds=[ int() ]):
    ...
    def convolve2d(self, outfile='', axes=[ int(0),int(1) ], type='gaussian', major=[ ], minor=[ ], pa=[ ], scale=float(-1), region=[ ], mask=[ ], overwrite=False, stretch=False, targetres=False, beam={ }):
    ...
    def fitprofile(self, box='', region=[ ], chans='', stokes='', axis=int(-1), mask=[ ], ngauss=int(1), poly=int(-1), estimates='', minpts=int(1), multifit=False, model='', residual='', amp='', amperr='', center='', centererr='', fwhm='', fwhmerr='', integral='', integralerr='', stretch=False, logresults=True, pampest=[ ], pcenterest=[ ], pfwhmest=[ ], pfix=[ ], gmncomps=[ ], gmampcon=[ ], gmcentercon=[ ], gmfwhmcon=[ ], gmampest=[ float(0.0) ], gmcenterest=[ float(0.0) ], gmfwhmest=[ float(0.0) ], gmfix=[ ], spxtype='', spxest=[ float() ], spxfix=[ False ], div=[ ], spxsol='', spxerr='', logfile='', append=True, pfunc=[ ], goodamprange=[ float(0.0) ], goodcenterrange=[ float(0.0) ], goodfwhmrange=[ float(0.0) ], sigma=[ ], outsigma='', planes=[ int() ]):
    ...
    def maskhandler(self, op='default', name=[ '' ]):
        ...
        brackets.
        """
        schema = {'op': {'type': 'cStr'}, 'name': {'type': 'cStrVec'}}
        doc = {'op': op, 'name': name}
        assert _pc.validate(doc,schema), str(_pc.errors)
    ...
    def open(self, infile):
        ...
        """
        schema = {'infile': {'type': 'cPath', 'coerce': _coerce.expand_path}}
        doc = {'infile': infile}
        assert _pc.validate(doc,schema), str(_pc.errors)
    ...
    def crop(self, outfile='', axes=[ int() ], overwrite=False, region=[ ], box='', chans='', stokes='', mask='', stretch=False, wantreturn=True):
    ...
    def sepconvolve(self, outfile='', axes=[ int(-1) ], types=[ '' ], widths=[ ], scale=float(-1), region=[ ], mask=[ ], overwrite=False, stretch=False):
        ...
        hanning.
        """
        schema = {'outfile': {'type': 'cStr'}, 'axes': {'type': 'cIntVec', 'coerce': _coerce.to_intvec}, 'types': {'type': 'cStrVec'}, 'widths': {'type': 'cVariant'}, 'scale': {'type': 'cFloat', 'coerce': _coerce.to_float}, 'region': {'type': 'cVariant'}, 'mask': {'type': 'cVariant'}, 'overwrite': {'type': 'cBool'}, 'stretch': {'type': 'cBool'}}
    ...
    def sethistory(self, origin='', history=[ '' ]):
        ...
        history.
        """
        schema = {'origin': {'type': 'cStr'}, 'history': {'type': 'cStrVec'}}
    ...
    def subimage(self, outfile='', region=[ ], mask=[ ], dropdeg=False, overwrite=False, list=True, stretch=False, wantreturn=True, keepaxes=[ int() ]):
    ...
    def pv(self, outfile='', start=[ ], end=[ ], center=[ ], length=[ ], pa=[ ], width=[ ], unit='arcsec', overwrite=False, region=[ ], chans='', stokes='', mask='', stretch=False, wantreturn=True):
