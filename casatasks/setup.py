...
def generate_pyinit(moduledir,tasks):
    ...
    with open(outfile, "w") as fd:
        ...
        fd.write("try:\n")
        fd.write("  from casatools import utils\n")
        fd.write("  utils = utils.utils()\n")
        fd.write("  telemetryflag = ''\n")
        fd.write("  if (utils.getrc('EnableTelemetry') != 'Unknown value'):\n")
        fd.write("    telemetryflag = utils.getrc('EnableTelemetry')\n")
        fd.write("  if telemetryflag != 'False':\n")   
