...
from CASAtools.__casac__ import msmetadata as _msmetadata
...
class msmetadata:
    ...
    def antennadiameter(self, antenna=[ ]):
    ...
    def antennaids(self, name=[ ], mindiameter=[ ], maxdiameter=[ ], obsid=int(-1)):
    ...
    def antennanames(self, antennaids=[ ]):
    ...
    def antennastations(self, which=[ ], obsid=int(-1)):
    ...
    def fieldsforscans(self, scans=[ int() ], asnames=False, obsid=int(-1), arrayid=int(-1), asmap=False):
