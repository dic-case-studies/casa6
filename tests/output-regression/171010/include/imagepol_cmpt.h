...
namespace casac {
  ...
  class  imagepol  {
    public:
      ...
      casac::image* linpolint(bool _debias=bool(false), double _clip=double(10.0), double _sigma=double(-1), const string& _outfile=string(""));
      casac::image* linpolposang(const string& _outfile=string(""));
      ...
      bool summary();
      casac::image* totpolint(bool _debias=bool(false), double _clip=double(10.0), double _sigma=double(-1), const string& _outfile=string(""));
