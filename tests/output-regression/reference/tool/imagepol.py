...
class imagepol:
    ...
    def linpolint(self, debias=False, clip=float(10.0), sigma=float(-1), outfile='', region='', mask='', stretch=False):
        ...
        """
        schema = {'debias': {'type': 'cBool'}, 'clip': {'type': 'cFloat', 'coerce': _coerce.to_float}, 'sigma': {'type': 'cFloat', 'coerce': _coerce.to_float}, 'outfile': {'type': 'cStr'}, 'region': {'type': 'cVariant'}, 'mask': {'type': 'cStr'}, 'stretch': {'type': 'cBool'}}
    ...
    def linpolposang(self, outfile='', region='', mask='', stretch=False):
        ...
        """
        schema = {'outfile': {'type': 'cStr'}, 'region': {'type': 'cVariant'}, 'mask': {'type': 'cStr'}, 'stretch': {'type': 'cBool'}}
