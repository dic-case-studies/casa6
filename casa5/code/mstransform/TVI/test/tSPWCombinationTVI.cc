            ...
            for(int nChannSpw0 = 64; nChannSpw0 <= 64; nChannSpw0*=2)
            {
                ...
                for(int nSpw = 1; nSpw <= 2; nSpw++)
                {
                    for(int nChannExponent = -2; nChannExponent <= 2; nChannExponent++)
                    {
                        ...
                        columns += VisBufferComponent2::ArrayId;
                        columns += VisBufferComponent2::Exposure;
                        columns += VisBufferComponent2::Feed1;
                        columns += VisBufferComponent2::Feed2;
                        columns += VisBufferComponent2::FieldId;
                        columns += VisBufferComponent2::FlagCube;
                        columns += VisBufferComponent2::FlagCubes;
                        columns += VisBufferComponent2::Frequencies;
                        columns += VisBufferComponent2::ObservationId;
