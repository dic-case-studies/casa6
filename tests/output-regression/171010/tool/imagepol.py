...
class imagepol:
    ...
    def depolratio(self, infile, debias=False, clip=float(10.0), sigma=float(-1), outfile=''):
        ...
        sigmadepolratio.
        """
        schema = {'infile': {'type': 'cStr'}, 'debias': {'type': 'cBool'}, 'clip': {'type': 'cFloat', 'coerce': _coerce.to_float}, 'sigma': {'type': 'cFloat', 'coerce': _coerce.to_float}, 'outfile': {'type': 'cStr'}}
