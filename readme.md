...
If some time has passed since the last build, you should (sometimes) remove *xml-casa-assembly-1.10.jar*, e.g.
```
-bash-4.2$ rm ./scripts/java/xml-casa-assembly-1.10.jar
-bash-4.2$ scripts/gcw-pick
```
